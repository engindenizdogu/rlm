...
def main():
    ...
    NUM_LINES = 100  # For testing, we can use a smaller number. Adjust as needed.
    ...
    rlm = RLM(
        backend="ollama",
        backend_kwargs={"model_name": "deepseek-r1:8b"}, #qwen2.5:7b, qwen2.5-coder:7b, qwen3:8b, deepseek-r1:8b
        environment="local",
        environment_kwargs={},
        max_depth=1,
        max_iterations=30,
